...
va a ingestar: el almacén de documentos fuente, el vector store gestionado donde
se guardan los embeddings, y la configuración de ingesta (chunking, embeddings),
junto con sus controles de acceso.
